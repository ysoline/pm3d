...
<head>
    ...
    <title><?= $title = "Planète Maker 3D" ?></title>
</head>
...
<body>
    <header class="blog-header">
        <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
            <div class="navbar-header">
                <a class="navbar-brand" href="./">Planète Maker 3D</a>
            </div>
            ...
            <div class="collapse navbar-collapse" id="navbarNavDropdown">
                <div class="d-flex flex-column flex-sm-row justify-content-between col-lg-11">
                    ...
                    <ul class="nav navbar-nav">
                        <li>
                            <?php if (!isset($_SESSION['id_user'])) { ?>
                            <a class="btn btn-sm btn-outline-light" href="connexion"><span
    ...
    <footer>
        <div class="blog-footer bg-dark text-center p-3">
            ...
            <small class="text-light">Planète Maker 3D</small><br />
