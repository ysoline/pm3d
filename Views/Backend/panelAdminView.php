                ...
                <?php foreach ($findPost as $post) { ?>
                    ...
                    <div class="lead d-flex justify-content-around">
                        <a class="btn btn-outline-primary btn" href="article&amp;id=<?= $post['id']; ?>" role="button">Lire
                            la suite</a>
                        <a class="btn btn-success" href="editionArticle&amp;id=<?= $post['id']; ?>" role="button">Modifier</a>
                    </div>
                    <hr class="my-4">
                <?php } ?>
            </div>
                ...
                <div class="bg-light rounded p-3">
                    ...
                    <?php foreach ($commentReport as $comment) { ?>
                        <div class="m-3">
                            ...
                            <a href="archiverCommentaire&amp;id=<?= $comment['c_id']; ?>" class="btn btn-outline-danger btn-sm" onclick='unpublished()'>Désapprouver</a>
                            <a href="validerCommentaire&amp;id=<?= $comment['c_id']; ?>" class="btn btn-outline-success btn-sm" onclick="commentOk()">Approuver</a>
                ...
                <div class="bg-light rounded p-3 mt-2">
                    ...
                    <?php foreach ($unpublished as $Uncomment) { ?>
                        <div class="m-3">
                            ...
                            <a href="publierCommentaire&amp;id=<?= $Uncomment['c_id']; ?>" class="btn btn-outline-success btn-sm" onclick="published()">Re-Publier</a>
